...
namespace Ilahiyyat.Areas.Admin_Panel.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,kitabin_adi,kitabin_faili")] Books book, HttpPostedFileBase kitabin_faili)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,kitabin_adi,kitabin_faili")] Books book, HttpPostedFileBase kitabin_faili)
        {
            if (ModelState.IsValid)
            {
                Random random = new Random();
