...
namespace Ilahiyyat.Areas.Admin_Panel.Controllers
{
    ...
    public class SermonsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Sermon sermon = db.Sermon.Find(id);
            if (sermon == null)
            {
                return HttpNotFound();
            }
        ...
        {
            IEnumerable<Sermon> srmn_list = db.Sermon.Where(e => e.xutbə_adi.Contains(search)).ToList();
